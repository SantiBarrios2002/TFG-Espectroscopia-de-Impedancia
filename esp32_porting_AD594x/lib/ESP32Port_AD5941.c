...
*/
void AD5940_RstSet_AD5941(void)
{
...
*/
void AD5940_RstClr_AD5941(void)
{
   gpio_set_level(AD5940_RST_PIN, 0); // assuming that initialisation has been done
}

uint32_t AD5940_GetMCUIntFlag_AD5941(void)
{
	return ucInterrupted;
}

uint32_t AD5940_ClrMCUIntFlag_AD5941(void)
{
	ucInterrupted = 0;
	return 1;
}
 ...
 * @return None
*/
void AD5940_Delay10us_AD5941(uint32_t time)
{
    if(time == 0)
        return;
...
/**
  ...
  @return None
**/
void AD5940_ReadWriteNBytes_AD5941(unsigned char *pSendBuffer,unsigned char *pRecvBuff,unsigned long length)
{
    ...
    spi_device_acquire_bus(spi_handle_ad5941, portMAX_DELAY);
    spi_device_transmit(spi_handle_ad5941, &t);
    spi_device_release_bus(spi_handle_ad5941);
...
/**
  ...
  @return always 0.
**/
uint32_t AD5940_MCUResourceInit_AD5941(void *pCfg)
{
	...
	ret = spi_bus_add_device(SENDER_HOST, &devcfg, &spi_handle_ad5941);
	assert(ret == ESP_OK);
...
board_interface_t ad5941_interface = {
    .CsSet = AD5940_CsSet_AD5941,
    .CsClr = AD5940_CsClr_AD5941,
    .RstSet = AD5940_RstSet_AD5941,
    .RstClr = AD5940_RstClr_AD5941,
    .GetMCUIntFlag = AD5940_GetMCUIntFlag_AD5941,
    .ClrMCUIntFlag = AD5940_ClrMCUIntFlag_AD5941,
    .Delay10us = AD5940_Delay10us_AD5941,
    .ReadWriteNBytes = AD5940_ReadWriteNBytes_AD5941,
    .MCUResourceInit = AD5940_MCUResourceInit_AD5941
};